...
/**
* 
* Java utility to list detailed change sets of a specific repository url in SVN after a specific date. It makes use
* of SVNKIT. 
*
...
public class ListChangedSets {
	...
	public static void main(String[] args) {
		 DAVRepositoryFactory.setup( );
		        ...
		        for ( Iterator entries = logEntries.iterator( ); entries.hasNext( ); ) {
		            ...
		            if(logEntry.getDate().compareTo(specifiedDate)>0)
		            {
			           ...
			           while (it.hasNext()) {
			                ...
			                System.out.println("Changed files: "+pair.getValue());
		    ...
		    //System.out.println("Set of modified folders in the svn path provided: "+set);
