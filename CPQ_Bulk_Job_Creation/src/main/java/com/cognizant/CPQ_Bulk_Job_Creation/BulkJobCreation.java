package com.cognizant.CPQ_Bulk_Job_Creation;
...
public class BulkJobCreation {
		...
		public static void main(String[] args) throws IOException {
		 ...
		 @SuppressWarnings({ "rawtypes", "unchecked" })
			...
			// each sheet's rows and on each row's cells. 
			        ...
			        for (int i = 1; i < sheetData.size(); i++) {
		                ...
		                XSSFCell svnUrl = (XSSFCell) list.get(1);
		                
		                String COMPONENT_NAME=componentName.getRichStringCellValue().getString();
		                String SVN_PATH=svnUrl.getRichStringCellValue().getString();
		                
		                BulkJobCreation.sendPost(COMPONENT_NAME,SVN_PATH,SPRINT_NO,
		 ...
		 public static void sendPost(String COMPONENT_NAME, String SVN_PATH,
				   String SPRINT_NO,String username,String password,String jobUrl) 
						   throws Exception     
			{
		  		
		  try {
	         String urlParameters = "COMPONENT_NAME="+COMPONENT_NAME+"&SVN_PATH="+SVN_PATH+"&SPRINT_NO="+SPRINT_NO;
